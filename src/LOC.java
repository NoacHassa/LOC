...
public class LOC {
  ...
  void set_fileCounter(int fileCounter) {
    
    this.fileCounter=fileCounter;
  }
  
  boolean get_commentOverRows() {
   
    return this.commentOverRows;
  }
  
  void set_commentOverRows(boolean commentOverRows) {
  ...
  boolean beginComment(String line) {
